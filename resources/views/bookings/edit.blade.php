        ...
        <div class="card mt-4">
            <div class="card-header bg-transparent">
                <div class="row align-items-center">
                    <div class="col">
                        <h5 class="h3 mb-0">Ubah Booking</h5>
                    </div>
                </div>
            </div>
            <div class="card-body">
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <option value="">Silahkan Pilih</option>
                                            ...
                                            <option value="{{$lapangan->id}}" {{ $lapangan->id == $booking->lapangan_id ? 'selected' : '' }}>{{ $lapangan->nama }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-xs-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" style="height:100px" name="notes"
                                            placeholder="Masukkan Catatan">{{ $booking->notes }}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
